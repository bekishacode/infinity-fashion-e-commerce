...
const Home: React.FC = () => {
  ...
  const portfolioItems = [
    { id: 1, title: 'Corporate Uniforms', client: 'Ethiopian Airlines', image: '/images/hoddie.png', category: 'wholesale' },
  ...
  return (
    <div>
                  ...
                  <ul className="space-y-2 mb-6">
                    {service.features.map((feature, idx) => (
                      <li key={idx} className="flex items-center text-sm text-gray-600">
                        <svg className="w-4 h-4 text-green mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
     ...
     {/* Stats Section - With Animated Counters */}
      <ScrollReveal direction="up">
        <div className="bg-gradient-to-r from-royal-blue to-magenta py-16">
      ...
      <ScrollReveal direction="up">
        <div className="bg-gray-50 py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-4 text-charcoal">Our Success Stories</h2>
            <p className="text-center text-gray-600 mb-12">Trusted by businesses across Ethiopia</p>
